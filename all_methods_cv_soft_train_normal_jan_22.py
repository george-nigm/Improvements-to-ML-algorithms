...
if __name__ == '__main__':
    X, y, dataset_name = load_and_split_data(10)
    y = y.values
    print('\nloading ended\n')
    ...
    for model_anoamalie in models_list:
        ...
        final_metrics.to_csv(f"results_expirements\hard_experiments\jan22-soft-10-training_normal/{dataset_name}-{model_anoamalie}.csv")
