...
if __name__ == '__main__':
    X, y, dataset_name = load_and_split_data(14)
    y = y.values
    print('\nloading ended\n')
    ...
    for model_anoamalie in models_list:
        ...
        final_metrics.to_csv(f"results_expirements\hard_experiments\jan22-training_all/{dataset_name}-{model_anoamalie}.csv")
